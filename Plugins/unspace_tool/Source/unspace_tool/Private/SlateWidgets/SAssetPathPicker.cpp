...
#define LOCTEXT_NAMESPACE "AssetPathPicker"

void SAssetPathPicker::Construct(const FArguments& InArgs)
{
	...
	PathPickerConfig.OnPathSelected = FOnPathSelected::CreateSP(this, &SAssetPathPicker::OnPathChange);
		...
		[
			...
			[
				...
				[
					...
					.OnClicked(this, &SAssetPathPicker::OnButtonClick, EAppReturnType::Ok)
				]
				...
				[
					...
					.HAlign(HAlign_Center)
					.ContentPadding(FEditorStyle::GetMargin("StandardDialog.ContentPadding"))
					.OnClicked(this, &SAssetPathPicker::OnButtonClick, EAppReturnType::Cancel)
				]
			]
		]);
}

void SAssetPathPicker::OnPathChange(const FString& NewPath)
{
	AssetPath = FText::FromString(NewPath);
}

FReply SAssetPathPicker::OnButtonClick(EAppReturnType::Type ButtonID)
{
...
bool SAssetPathPicker::ValidatePackage()
{
	FText Reason;
...
EAppReturnType::Type SAssetPathPicker::ShowModal()
{
	GEditor->EditorAddModalWindow(SharedThis(this));
	return UserResponse;
}

const FText& SAssetPathPicker::GetAssetPath()
{
	return AssetPath;
}

const FText& SAssetPathPicker::GetAssetName()
{
	return AssetName;
}

FText SAssetPathPicker::GetFullAssetPath()
{
